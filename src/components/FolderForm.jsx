...
export default function FolderForm(){
    ...
    const { showFolderForm, folders, setShowFolderForm, setIsEditingNotes, setFolders, notesToEdit, setNotesToEdit, setNotes, setIsLoaded, setShowSettings } = userStore()
